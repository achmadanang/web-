        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="trending__product">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md- col-sm- bg-white shadow-sm m-3 p-2">
                            <div class="product__item">
                                <img class="w-100" src="{{asset('admin/img/img1.jpg')}}" alt="...">
                                <div class="mb-1">
                                </div>
                                <div class="product__item__text">
                                    <h5><a href="#">Attack On Titan S3</a></h5>
                                    <a>action drama</a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md- col-sm- bg-white shadow-sm m-3 p-2">
                            <div class="product__item">
                                <img class="w-100" src="{{asset('admin/img/img2.jpg')}}" alt="...">
                                <div class="mb-1">
                                </div>
                                <div class="product__item__text">
                                    <h5><a href="#">Demon Slayer: Kimetsu no Yaiba</a></h5>
                                    <a>action drama</a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md- col-sm- bg-white shadow-sm m-3 p-2">
                            <div class="product__item">
                                <img class="w-100" src="{{asset('admin/img/img3.jpg')}}" alt="...">
                                <div class="mb-1">
                                </div>
                                <div class="product__item__text">
                                    <h5><a href="{{url('/detail')}}">My Name</a></h5>
                                    <a>action drama</a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md- col-sm- bg-white shadow-sm m-3 p-2">
                            <div class="product__item">
                                <img class="w-100" src="{{asset('admin/img/img4.jpg')}}" alt="...">
                                <div class="mb-1">
                                </div>
                                <div class="product__item__text">
                                    <h5><a href="#">Vincenzo</a></h5>
                                    <a>action drama</a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md- col-sm- bg-white shadow-sm m-3 p-2">
                            <div class="product__item">
                                <img class="w-100" src="{{asset('admin/img/img5.jpg')}}" alt="...">
                                <div class="mb-1">
                                </div>
                                <div class="product__item__text">
                        ...
                        <div class="col-lg-3 col-md- col-sm- bg-white shadow-sm m-3 p-2">
                            <div class="product__item">
                                <img class="w-100" src="{{asset('admin/img/img6.jpg')}}" alt="...">
                                <div class="mb-1">
                                </div>
                                <div class="product__item__text">
                                    <h5><a href="#">Itaewon Class</a></h5>
                                    <a>action drama</a>
                                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-8">
                <div class="product__sidebar">
                    <div class="product__sidebar__view">
                        ...
                        <div class="bg-white shadow-sm m-2 p-2">
                            <img class="w-100" src="{{asset('admin/img/img1.jpg')}}" alt="...">
                            <div class="product__sidebar__view__item set-bg mix day years mb-5">
                                <a></a>
