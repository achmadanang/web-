    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">NOPAD</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('/action')}}"></i> Action</a>
                        <a class="collapse-item" href="{{url('/horor')}}">Horor</a>
                        <a class="collapse-item" href="{{url('/next')}}">Data Pelanggan</a>
                        <a class="collapse-item" href="">Data Jenis Produk</a>
                        <a class="collapse-item" href="">Data Kartu</a>
